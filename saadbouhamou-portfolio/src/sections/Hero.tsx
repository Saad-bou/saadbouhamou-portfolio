...
export default function Hero() {
  ...
  return (
    <Section
      id="home"
      className="flex items-center justify-center overflow-hidden relative min-h-[100svh] lg:min-h-[100dvh]"
    >
      ...
      <Container className="relative z-10 [@media(min-width:1800px)]:max-w-[85vw] [@media(min-width:1800px)]:px-[5vw]">
        {/* Mobile-first: الصورة فوق، والنص تحت. على lg+ كتنقلب */}
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10 lg:gap-12 [@media(min-width:1800px)]:gap-[8vw]">
