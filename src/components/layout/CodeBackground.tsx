...
export default function CodeBackground() {
  ...
  return (
    ...
    >
      {/* 1. Line Numbers — مخبيين على الموبايل باش ما يتداخلوش مع الـ Hero text */}
      <div className="hidden md:block absolute left-0 top-0 h-full w-14 border-r border-white/[0.03] bg-transparent pt-32">
        <div className="flex flex-col items-center gap-2 font-mono text-xs text-terminal/20">
          {[...Array(60)].map((_, i) => (
      ...
      {/* 2. Floating Code Snippets — مخبيين على الشاشات الصغيرة */}
      <div className="absolute inset-0 font-mono text-sm sm:text-base text-terminal/[0.06]">
        {/* Snippet 1 - Top Right */}
        <div className="absolute top-[15%] right-[5%] rotate-3 hidden sm:block">
        ...
        {/* Snippet 2 - Mid Left */}
        <div className="absolute top-[50%] left-[10%] -rotate-12 opacity-60 hidden md:block">
        ...
        {/* Snippet 3 - Bottom Right */}
        <div className="absolute bottom-[15%] right-[15%] rotate-6 hidden sm:block">
